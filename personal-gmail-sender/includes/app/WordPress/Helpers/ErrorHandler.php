...
class ErrorHandler
{
    private static $viewsDir = NUMBERS_ANALYZER_PLUGIN_DIR . '/includes/resources/views';
    private static $cacheDir = NUMBERS_ANALYZER_PLUGIN_DIR . '/includes/resources/cache';
    /**
     * @var \Throwable
     */
