...
class BladeOne
{
     ...
     * <b>Example:<b><br>
     * <pre>
     * $this->setnumbers_analyzer_view('folder.view')->share(['var1'=>20])->run(); // or $this->run('folder.view',['var1'=>20]);
     * </pre>
     *
     * @param string $view
     * @return BladeOne
     */
    public function setnumbers_analyzer_view($view): BladeOne
    {
        $this->viewStack = $view;
        return $this;
    }
    ...
    public function checkHealthPath(): bool
    {
        ...
        echo "numbers_analyzer_view(s) found :" . count($files) . "\n";
        return $status;
    }
